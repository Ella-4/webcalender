...
<style>
    ...
    .stSelectbox > div > div {
        ...
        border-radius: 16px;
        background: linear-gradient(135deg, #ffffff 0%, #f6fdf6 100%);
        box-shadow: 0 2px 8px rgba(74, 222, 128, 0.04);
    }
    ...
    .stMultiSelect [data-testid="stMultiSelectTag"]:hover {
        background: linear-gradient(135deg, #fed7aa 0%, #fef3c7 100%) !important;
    }
    
    /* 다른 Streamlit 요소들 색상 통일 */
    .stSelectbox [data-testid="stSelectbox"] > div {
        border-color: rgba(251, 191, 36, 0.2) !important;
    }
    
    .stSelectbox [data-testid="stSelectbox"] > div:focus-within {
    ...
    /* 사이드바 */
    .css-1d391kg {
        background: linear-gradient(180deg, #f6fdf6 0%, #ffffff 100%);
